...
if "initialized" not in st.session_state:
    ...
    st.session_state.settings = {
        ...
        "system_prompt": """You are a helpful AI assistant that answers questions based on the provided records related to security report and issues.
...
st.set_page_config(
    page_title="Graph / native / Hydrid RAG",
    page_icon="😎",
    layout="wide",
...
# Configure logging
working_dir = "/home/ngoan/cakespace/bio/nlp/LightRAG-gui/examples"
...
def show_settings_dialog():
    ...
    st.session_state.settings["llm_model"] = AVAILABLE_LLM_MODELS[0]  # Use first model as default
    st.session_state.settings["embedding_model"] = AVAILABLE_EMBEDDER_MODELS[0]  # Use first model as default
...
def show_kg_stats_dialog():
    ...
    try:
        ...
        graph_path = "./local_storage/graph_chunk_entity_relation.graphml"
        ...
        if stats["Nodes"] > 0:
            ...
            try:
                ...
                html_path = "./local_storage/graph_chunk_entity_relation.html"
